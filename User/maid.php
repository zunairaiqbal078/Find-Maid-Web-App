...
<?php
    ...
    $select = "SELECT * FROM `maid_record` where status = 'free'";
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 offset-sm-0 col-12 offset-0 cl1 p-2">
                <div class="card" style="height: 350px;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="purchaseMaid.php?maidId=<?php echo $result['maidId'] ?>" style="color: white; position: absolute; bottom:5%;" class="btn btn-warning ps-4 pe-4 text-light " style="border-radius: 10px;">I'm Interested</a>
                    </div>
                </div>
            </div>
            <?php
