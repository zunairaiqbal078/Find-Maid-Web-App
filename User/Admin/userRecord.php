...
<?php
    include ('conn.php');
    $select = " SELECT * FROM user_record order by userId desc";
                ...
                <div class="col ccl1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo $result2['mobile']?></td>
                            <td><?php echo $result2['address']?></td>
                            <td><?php echo $result2['city']?></td>
                            <td><?php echo $result2['country']?></td>
                            <td><?php echo $result2['zipCode']?></td>
                            <td><a href="deleteUserRecord.php?record=<?php echo $result2['userId'] ?>">Delete</a></td>
                        </tr>
                            <?php
                            } 
                            ?>
